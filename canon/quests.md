...
- **Status:** In progress — Funnel route reopening; Emperor Shen weakened until at least the next moon
- **Details:** [[Aeris]] is imprisoned inside [[Starfall]], her mortal body aging and weakening. [[Lyngbakr]] repaired the [[Hole in the Sky]], but Starfall and Aeris remain unresolved. [[Fharan]] warned that Starfall's next target is [[Sigil]], the sun. [[Courteous Cam]] and [[Otto]] are reopening the [[The Funnel|Funnel]] route toward [[Axis Mundi]]. The completed [[Chart of the Witness]] suggests Axis Mundi lies beyond a planar boundary rather than through an ordinary underground route. The party's [[Antumbra]] in the League's supply chain may still sabotage Starfall when fed as fuel.

## Kill the Tome Keeper
- **Given by:** [[Rakshasa]]
- **Status:** In progress — party's next destination
...
## Stop the Demi-Spell / confront Boral Erendel
- **Given by:** [[Crone]], [[Ceril]] (own initiative)
- **Status:** In progress
- **Details:** [[The Order of Seasons]] is pursuing the [[Demi-Spell]] to reset the world. [[Boral Erendel]] has gone rogue with an eugenics version of the plan — creating thousands of empty high elf forms to reincarnate all spirits into "perfect" bodies. [[Crone]] confirmed there is time to stop the Demi-Spell but warned the party is more likely to die than run out of time. [[Ceril]] proposed capturing or assassinating the [[Rakshasa]] as leverage against [[Keys]] to halt the Demi-Spell entirely.
