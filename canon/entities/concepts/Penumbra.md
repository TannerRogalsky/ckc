...
sessions_appeared: ["013", "014", "016", "017", "021", "030", "031", "033"]
related:
  - "[[Akasha]]"
  - "[[Obvolvo Caelum]]"
  - "[[The Carrot Cake]]"
...
In session 030, all four lamps in [[The Carrot Cake]] were lit, opening access to [[Jack Harvey]]'s inner sanctum where Penumbra is expected to be stored. [[Vizier Jade]] and [[Emperor Shen]] exploited the party's rest to search for it while they were trapped away from the opened door. In the same session, [[Red Caesar]] completed [[Obvolvo Caelum]], a spell that can condense Penumbra at any size and may greatly improve the party's ability to move or reshape it.

In session 031, the party opened [[Jack Harvey]]'s underwater vault and found Penumbra crystallized across the walls, in both shards and sand-like deposits. [[Red Caesar]] used [[Obvolvo Caelum]] to condense the vault's contents into a small orb containing more sky-material than all previous Penumbra finds combined. After the party returned to [[Lyngbakr Lagoon]], Red Caesar released the condensed Penumbra to [[Lyngbakr]]. The turtle consumed it and repaired the [[Hole in the Sky]], closing smaller wounds across Stark before passing into the heavens with [[Ceril]] and [[Alamar]].
